...
public class TestMetricGroup {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[contains(text(),'Create Metric Grouping')]")).click();
		
		
		driver.findElement(By.id("metricGroupingName")).sendKeys("ABCD Test Metrics2");
		...
		act.sendKeys("SaaS").build().perform();
		act.sendKeys(Keys.TAB).build().perform();
		driver.findElement(By.xpath("//textarea[@name='description']")).sendKeys("ABCD Test Metrics2 Description");
		driver.findElement(By.name("agentExpression")).sendKeys("datanode\\-es\\-jetstream\\-ld1\\-load\\-(.*)\\|Infrastructure\\|Agent");
		driver.findElement(By.name("metricExpression")).sendKeys("SystemEdge\\|datanode\\-es\\-jetstream\\-ld1\\-load\\-(.*)\\.us\\-(.*)\\-b\\.c\\.saas\\-dev\\-us\\-sedjetstream\\-load\\.internal\\|CPU:TotalUserPercent");
